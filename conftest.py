...
def new_page(playwright: Playwright, request):
    ...
    page.set_default_timeout(500000)  # 500 seconds
    page.set_default_navigation_timeout(500000) # Increased timeouts due to Github Actions taking too long loading pages
